<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CPE02-SD.aspx.cs" Inherits="Web_Senior_Project.Page.CPE02_SD" %>
               ...
               <td style="background-color: #FFFFCC; " class="auto-style19">
                ...
                <tr>
                        ...
                        <table style="height: 150px; width: 250px;">
                            <tr>
                                <td style="border:solid 2px #09F; background-color: #FFFFCC;" align="top" valign="top">
                                    ...
                                    <li style="width: 250px; background-color: #FFCCFF; height: 20px;"><a href="CPE06-SD.aspx" />ขอสอบโครงงาน</a></li>
                                    <li style="width: 250px; background-color: #99CCFF;"><a href="CPE07-SD.aspx" />ประเมินโครงงาน</a></li>
                                    <li style="width: 250px; background-color: #FFCCFF;"><a href="Money.aspx" style="overflow: auto" />ใบสำคัญรับเงินโครงงาน</a></li>
                                </td>
                    ...
                    <td align ="left" valign ="top" >
                        <br />
                        <asp:Label ID="Label2" runat="server" Text="ชื่อโครงงาน"></asp:Label>
                        <br />
                        <asp:DropDownList ID="DropDownList1" runat="server">
                        </asp:DropDownList>
                        <br />
                        <br />
                        <asp:Label ID="Label3" runat="server" Text="รหัสโครงงาน"></asp:Label>
                        ...
                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False">
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="งานที่มอบหมาย" />
                                <asp:BoundField HeaderText="ข้อสรุป" />

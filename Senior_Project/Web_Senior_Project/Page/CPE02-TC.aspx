<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CPE02-TC.aspx.cs" Inherits="Web_Senior_Project.Page.CPE02_TC" %>
...
<!--------------------------------------table -------------------------------------------------->
        ...
        <table style="height: 612px; width: 1000px; background-color: #FFFFFF; border:solid 2px #09F;" bgcolor="#ffff1f" align="center">
            <tr>
               ...
               <td style="background-color: #FFFFCC; " class="auto-style19">
                ...
                <tr>
                    ...
                    <td align ="left" valign ="top" class="auto-style38"> 
                        <asp:Panel ID="Panel1" runat="server" Height="200px" Width="200px">
                            <asp:GridView ID="GridView1" runat="server" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" style="text-align: left">
                            </asp:GridView>
                        </asp:Panel>
                    </td>
                </tr>
